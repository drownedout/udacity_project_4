...
# User
user1 = User(name="Sally Sample", email="testing@test.com",
...
categoryItem2 = CategoryItem(name="Iphone 8", description="Let's face it. You definitely need to buy another one. You wanna be cool, right?", category=category2, user=user1)
