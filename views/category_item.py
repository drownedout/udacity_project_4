    ...
    try:
        if session['username']:
            ...
            if request.method == 'POST':
                ...
                return redirect(
                    url_for(
                        'categoryItem.categoryItemShow',
                        category_id=newCategoryItem.category_id,
                        item_id=newCategoryItem.id))
            else:
                return render_template(
                    'categoryItems/new.html',
...
def categoryItemShow(category_id, item_id):
    categoryItem = database_session.query(
        ...
        if session['username']:
            ...
            if session['user_id'] != editCategoryItem.user_id:
                return redirect(
                    url_for(
                        'categoryItem.categoryItemShow',
                        category_id=editCategoryItem.category_id,
